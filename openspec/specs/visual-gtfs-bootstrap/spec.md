# visual-gtfs-bootstrap Specification

## Purpose
Define the LED-matrix status behavior used to bootstrap missing GTFS snapshots before the live arrival display starts.
